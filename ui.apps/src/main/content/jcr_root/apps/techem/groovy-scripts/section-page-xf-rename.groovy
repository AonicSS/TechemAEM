...
def sqlQuery = "select [jcr:path], * from [nt:unstructured] as a where [cq:template] = '/conf/techem/settings/wcm/templates/section-page' and isdescendantnode(a, '/content/techem')";
